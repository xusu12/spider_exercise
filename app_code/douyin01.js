...
function call_java(){
    ...
    Java.perform(function(){
        var retrofit2_mime_FormUrlEncodedTypedOutput = Java.use('com.bytedance.retrofit2.mime.FormUrlEncodedTypedOutput').$new();
        var X_SS_STUB = retrofit2_mime_FormUrlEncodedTypedOutput.md5Stub();
        console.log('X_SS_STUB : ', X_SS_STUB);
        console.log('Success！');
    });
...
function java_hook01(){
    Java.perform(function(){
        // var retrofit2_mime_FormUrlEncodedTypedOutput = Java.use('com.bytedance.retrofit2.mime.FormUrlEncodedTypedOutput');
        // retrofit2_mime_FormUrlEncodedTypedOutput.md5Stub.overload().implementation = function(){
        //     console.log(111, bytesToString(this.content));
        //     console.log(this.md5Stub());
        //     return this.md5Stub();
        // };
    
        var retrofit2_mime_FormUrlEncodedTypedOutput = Java.use('com.bytedance.retrofit2.mime.FormUrlEncodedTypedOutput');
        retrofit2_mime_FormUrlEncodedTypedOutput.addField.overload('java.lang.String', 'boolean', 'java.lang.String', 'boolean').implementation = function(ars1, ars2, ars3, ars4){
            showStacks();
            console.log('retrofit2_mime_FormUrlEncodedTypedOutput.addField ars1 : ', ars1);
            console.log('retrofit2_mime_FormUrlEncodedTypedOutput.addField ars2 : ', ars2);
            console.log('retrofit2_mime_FormUrlEncodedTypedOutput.addField ars3 : ', ars3);
            console.log('retrofit2_mime_FormUrlEncodedTypedOutput.addField ars4 : ', ars4);
            var result = this.addField(ars1, ars2, ars3, ars4);
            console.log('retrofit2_mime_FormUrlEncodedTypedOutput.addField result : ', result);
            return result
        };
