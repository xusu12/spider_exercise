...
function _yrxtSa(_yrx7jl) {
    if (_yrx7jl !== _yrxY1C && _yrx7jl !== null && (typeof _yrx7jl === "string" || _yrx7jl["toString"])) {
        if (_yrx7jl !== '') {
...
function _yrxR2F(_yrx7jl) {
    var _yrxrqQ = _yrx7jl.length, _yrx$Kn = new Array(_yrxrqQ), _yrxmEu;
    for (_yrxmEu = 0; _yrxmEu < _yrxrqQ; _yrxmEu++) {
        var _yrx2LR = Function.prototype.call(_yrx7jl, _yrxmEu);
        if (32 > _yrx2LR || _yrx2LR > 126) {
            _yrx$Kn[_yrxmEu] = encodeURIComponent(Function.prototype.call(_yrx7jl, _yrxmEu))
        } else {
            _yrx$Kn[_yrxmEu] = Function.prototype.call(_yrx7jl, _yrxmEu)
        }
    }
    return _yrx$Kn.join('')
}
...
function _yrxyA$(_yrx7jl, _yrxcze) {
        ...
        var _yrxmEu = _yrxWKg(_yrxyHJ(encodeURIComponent(_yrx$Kn._yrx2ad + _yrx$Kn._yrxAmM)));
...
var res = _yrxyA$("/api/match/10?page=2&");
console.log(res);