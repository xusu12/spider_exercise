(function xd(o) {
    ...
    function s(e, t) {
        ...
        for (n = 0; n < e.length; n += 16)
            (r = d),
                ...
                (a = h),
                (s = v),
                (d = u(d, p, h, v, e[n], 7, -680876936)),
                (v = u(v, d, p, h, e[n + 1], 12, -389564586)),
                (h = u(h, v, d, p, e[n + 2], 17, 606105819)),
                (p = u(p, h, v, d, e[n + 3], 22, -1044525330)),
                (d = u(d, p, h, v, e[n + 4], 7, -176418897)),
                (v = u(v, d, p, h, e[n + 5], 12, 1200080426)),
                (h = u(h, v, d, p, e[n + 6], 17, -1473231341)),
                (p = u(p, h, v, d, e[n + 7], 22, -45705983)),
                (d = u(d, p, h, v, e[n + 8], 7, 1770035416)),
                (v = u(v, d, p, h, e[n + 9], 12, -1958414417)),
                (h = u(h, v, d, p, e[n + 10], 17, -42063)),
                (p = u(p, h, v, d, e[n + 11], 22, -1990404162)),
                (d = u(d, p, h, v, e[n + 12], 7, 1804603682)),
                (v = u(v, d, p, h, e[n + 13], 12, -40341101)),
                (h = u(h, v, d, p, e[n + 14], 17, -1502002290)),
                (d = c(
                    d,
                    (p = u(p, h, v, d, e[n + 15], 22, 1236535329)),
                    h,
                    v,
                    e[n + 1],
                    5,
    ...
    function m(e, t) {
        return (function(e, t) {
            ...
            return (
                (r = s(i.concat(p(t)), 512 + 8 * t.length)), d(s(a.concat(r), 640))
            );
        })(v(e), v(t));
    }
    function b(e, t, n) {
    ...
    var re = b("/xdnphb/nr/cloud/douyin/accountSearch?AppKey=joker&nonce=70938efbd");
    console.log(re)
})();